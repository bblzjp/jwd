...
public class sanshimiao extends Activity {
...
StrictMode.setVmPolicy(new StrictMode.VmPolicy.Builder()
		...
		btn3.setOnClickListener(new OnClickListener(){
			public void onClick(View v){
				...
				intent.setClass(sanshimiao.this,Register.class);
		...
		btn5.setOnClickListener(new OnClickListener(){
			public void onClick(View v) { 
				Intent intent=new Intent();
				intent.setClass(sanshimiao.this,clzk.class);
				startActivity(intent); 
			}
		});
		...
		btn4.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intent=new Intent();
				intent.setClass(sanshimiao.this, sjsz.class);
				startActivity(intent);
			}
		});
		...
		timer.schedule(task,0,30*1*1000);
			...
			public void onClick(View v) {
				...
				sj.setText(""+str1);
				 dbUtil.insertCargoInfo(String.valueOf(latitude), String.valueOf(longitude),uniqueId,str1);  
	                ...
	                hideButton(false);  
	                Toast.makeText(sanshimiao.this, "成功上传数据", Toast.LENGTH_SHORT).show(); 
			}
		});
