...
public class sanshifen extends Activity {
...
StrictMode.setVmPolicy(new StrictMode.VmPolicy.Builder()
		...
		btn3.setOnClickListener(new OnClickListener(){
			public void onClick(View v){
				...
				intent.setClass(sanshifen.this,Register.class);
		...
		btn4.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intent=new Intent();
				intent.setClass(sanshifen.this, sjsz.class);
				startActivity(intent);
			}
		});
		...
		btn5.setOnClickListener(new OnClickListener(){
			public void onClick(View v) { 
				Intent intent=new Intent();
				intent.setClass(sanshifen.this,clzk.class);
				startActivity(intent); 
			}
		});
			...
			public void onClick(View v) {
				...
				sj.setText(""+str1);
				 dbUtil.insertCargoInfo(String.valueOf(latitude), String.valueOf(longitude),uniqueId,str1);  
	                ...
	                hideButton(false);  
	                Toast.makeText(sanshifen.this, "成功上传数据", Toast.LENGTH_SHORT).show(); 
			}
		});
