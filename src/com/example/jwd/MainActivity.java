...
StrictMode.setVmPolicy(new StrictMode.VmPolicy.Builder()
		...
		btn4.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intent=new Intent();
				intent.setClass(MainActivity.this, sjsz.class);
				startActivity(intent);
			}
		});
...
//				// TODO Auto-generated method stub
//				Intent intent=new Intent();
//				intent.setClass(MainActivity.this, clzk1.class);
//				startActivity(intent);
//			}
//		});
...
//				Log.i(TAG, "latitude = " + latitude + ",longitude = " + longitude);
		...
		final String la=String.valueOf(latitude);
		final String lo=String.valueOf(longitude);
		...
		TimerTask task=new TimerTask(){
			public void run(){
				...
				dbUtil.insertCargoInfo(la, lo,uniqueId,str1);  
			...
			public void onClick(View v) {
				...
				sj.setText(""+str1);
				 dbUtil.insertCargoInfo(String.valueOf(latitude), String.valueOf(longitude),uniqueId,str1);  
	                ...
	                hideButton(false);  
	                Toast.makeText(MainActivity.this, "成功上传数据", Toast.LENGTH_SHORT).show(); 
			}
		});
		...
		btn5.setOnClickListener(new OnClickListener(){
			public void onClick(View v) { 
				Intent intent=new Intent();
				intent.setClass(MainActivity.this,clzk.class);
				startActivity(intent); 
			}
		});
